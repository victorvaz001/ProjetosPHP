    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="addNoticia.php">Adicionar Noticías</a>
          </li>
          <li class="nav-item dropdown">
			<a class="nav-link" href="logout.php" onclick="return confirm('Deseja sair do sistema?');">Sair</a>
          </li>
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            ...
            <span class="subheading">
              <?php
            		echo "Bem vindo ao Sistema ".'<a href="adminPage.php" style="color: white;">'.$nome.'</a><br/><br/>';
            ?>     
            </span>
          </div>
        </div>
  	...
  	<div class="row">
  		<div class="col-lg-8 col-md-10 mx-auto">
  			<div class="post-preview">
  				<?php echo '<a href="updateNoticia.php?id='.$noticia["id"].'"
  					class="btn btn-info" style="color: white;">Update</a>'?>

  					<span onclick="return confirm('Confirma exclusão?');"><?php echo '<a href="deleteNoticia.php?id='.$noticia["id"].'"
  					class="btn btn-info" style="color: white;">Delete</a>'?></span>
  				<a href="index.php">        	
  					<h2 class="post-title">
